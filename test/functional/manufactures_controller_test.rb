...
class ManufacturesControllerTest < ActionController::TestCase
  ...
  test "should create manufacture" do
    assert_difference('Manufacture.count') do
      post :create, manufacture: { certification: @manufacture.certification, contactor: @manufacture.contactor, location: @manufacture.location }
    end
  ...
  test "should update manufacture" do
    put :update, id: @manufacture, manufacture: { certification: @manufacture.certification, contactor: @manufacture.contactor, location: @manufacture.location }
    assert_redirected_to manufacture_path(assigns(:manufacture))
  end
