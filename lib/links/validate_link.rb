...
# original credits: http://blog.inquirylabs.com/2006/04/13/simple-url-validation/
# HTTP codes: http://www.ruby-doc.org/stdlib/libdoc/net/http/rdoc/classes/Net/HTTPResponse.html

class ActiveRecord::Base
  def self.validates_url_existence_of(*attr_names)
    ...
    raise(ArgumentError,
          ...
          until configuration[:with].is_a?(Regexp)
